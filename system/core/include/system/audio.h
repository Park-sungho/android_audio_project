...
typedef enum {
    AUDIO_OEM_POLICY_SESSION_NONE = AUDIO_DEVICE_NONE,
    AUDIO_OEM_POLICY_SESSION_BT = AUDIO_DEVICE_OUT_SPEAKER | AUDIO_DEVICE_OUT_BLUETOOTH_A2DP,
    AUDIO_OEM_POLICY_SESSION_SUBMIX = AUDIO_DEVICE_OUT_SPEAKER | AUDIO_DEVICE_OUT_REMOTE_SUBMIX,
    AUDIO_OEM_POLICY_SESSION_LINE = AUDIO_DEVICE_OUT_LINE,    
} audio_oem_policy_t;;
